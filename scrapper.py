...
print()
print(tickers)
#for windows os: tickerFile = open('C://Users//vasantgc//Documents//StockPredictions2.0//tickers.csv','w')
...
for ticks in tickerToLink:
    ...
    #for windows os: fOpen = open('C://Users//vasantgc//Documents//StockPredictions2.0//data//'+ticks+".csv",'w')
